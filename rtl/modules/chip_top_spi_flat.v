// chip_top_spi_flat.v — Padring wrapper for cnn_top with SPI interface
// FLAT version: cnn_top is synthesized inline (not a blackbox macro)
...
`endif
    ...
    // Flat flow — cnn_top is synthesized, NOT a blackbox macro
    // -------------------------------------------------------
    cnn_top u_core (
        .clk       (clk_core       ),
        .reset     (reset_core     ),
