...
iverilog -g2012 -DPOSTSYNTH -DFUNCTIONAL -o ${SIM_DIR}/tb_top_obi_postsynth.out \
...
cd ${SIM_DIR} && vvp tb_top_obi_postsynth.out +NUM_IMAGES=${NUM_IMAGES} +CLK_PERIOD_NS=${CLK_PERIOD}
