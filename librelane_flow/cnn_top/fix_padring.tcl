...
# Modified for Sky130: add rotation parameters to make_io_sites
# Based on LibreLane default pad_cfg.tcl
...
# Sky130 pad rotation fix:
# Official OpenROAD sky130 test scripts (skywater130_caravel.tcl,
# skywater130_coyote_tc.tcl) all use R180 for all three rotations.
# Note: rotation_horizontal applies to WEST/EAST rows,
#       rotation_vertical applies to SOUTH/NORTH rows.
make_io_sites \
